...
# 1: Input Root GUI
input_root = Tk()
bgimage = PhotoImage(file = r"C:\Users\Pooja\Documents\.py_files\chat_app\bg.png")
...
# 2: Main Root GUI
root = Tk()
bgimage2 = PhotoImage(file =r"C:\Users\Pooja\Documents\.py_files\chat_app\bg.png")
